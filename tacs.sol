...
contract TaceToken{
    address owner;
    string public constant name = "Tace Token";
    ...
    function transfer(address _to, uint _value){
        ...
        require(_to != address(0));//주소를 입력하지 않은 경우의 예외처리
        require(balanceOf[_from]>=_value);//잔고가 부족한 경우의 예외처리
    ...
    function TaceToken(address _icoAddress){
        owner = msg.sender;
